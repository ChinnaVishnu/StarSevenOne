...
public class mainbaseLatest extends Utills {
	...
	public void latestsecondWWW() throws InterruptedException {
		Thread.sleep(9000);
		...
		elementname.sendKeys(Repository.getProperty("app_username"));
		mainbaseLatest.highLightElement(driver, elementname);

		impliciteWait(50);
		WebElement elementsepp = driver.findElement(By.xpath(".//*[@id='pwdt']"));
		elementsepp.sendKeys(Repository.getProperty("app_password"));
	...
	public void loadPropertiesFile() throws IOException {
		...
		//f = new File("D:\\AdvancedSTAR\\config.properties");
		 f=new

...
public class FalsePositiveAddby extends mainbaseLatest {
	...
	public void testprofiles() throws InterruptedException{
    	...
    	fluentWait(By.xpath(".//*[@id='textAddedBy-inputEl']")).sendKeys("l1_user");
    	
    	fluentWait(By.xpath(".//*[@id='textAddedBy-inputEl']")).sendKeys(Keys.ENTER);

...
public class GridAddReport3 extends mainbaseLatest {
	...
	public void GridTest() {
		...
		try {
			...
			fluentWait(By.xpath("//tr[14]/td[2]/table/tbody/tr/td[2]/table/tbody/tr/td[2]/div")).click();
			...
			sleep(8);
			fluentWait(By.xpath("//tr[16]/td[2]/table/tbody/tr/td[2]/table/tbody/tr/td[2]/div")).click();

			fluentWait(By.xpath("//li[text()='BANK']")).click();

			fluentWait(By.xpath("//tr[21]/td[2]/table/tbody/tr/td[2]/table/tbody/tr/td[2]/div")).click();
			...
			ExtentTestManager.getTest().log(LogStatus.INFO,"Created User " +user + raaaa);
			
	String sendingemail=driver.findElement(By.xpath("//div[@class='x-form-display-field']")).getText();
	//System.out.println(sendingemail);	
	
			String s = sendingemail;
			int indexOfLast = s.lastIndexOf(".");
			String newString = s;
			if (indexOfLast >= 0)
				newString = s.substring(24, indexOfLast);
			System.out.println(newString);
			
			
		String excepted="User has been added successfully";	
			if(newString.equals(excepted)){
				System.out.println("User Added Updated Successfully pass");
				ExtentTestManager.getTest().log(LogStatus.INFO, "Screenshortbelow :" + ExtentTestManager.getTest()
				.addScreenCapture(GetScreenshort.capture(driver, "ScreenshortForExtentReport")));
				...
				ExtentTestManager.getTest().log(LogStatus.FAIL,"User not added");
			...
			ExtentTestManager.getTest().log(LogStatus.FAIL, "Missing the modules");

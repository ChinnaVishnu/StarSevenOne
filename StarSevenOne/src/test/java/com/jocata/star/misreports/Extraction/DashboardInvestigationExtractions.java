...
public class DashboardInvestigationExtractions  extends mainbaseLatest{
	...
	public void clickrules() throws InterruptedException, IOException, HeadlessException, AWTException{
		...
		ExtentTestManager.startTest(" MIS Reports :  DashboardInvestigation   Report  ");
		...
		fluentWait(By.xpath("(//img[@title='VIEW'])[4]")).click();
		 ...
		 try{
				...
				ExtentTestManager.getTest().log(LogStatus.INFO, "DashboardInvestigation Report downloaded sucessfully");

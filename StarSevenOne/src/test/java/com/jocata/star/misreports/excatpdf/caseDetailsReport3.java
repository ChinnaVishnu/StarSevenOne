...
import com.jocata.star.RunStar.ReadPDFFine3;
...
public class caseDetailsReport3 extends mainbaseLatest {
...
"text/csv,application/x-msexcel,application/excel,application/x-excel,application/vnd.ms-excel,image/png,image/jpeg,text/html,text/plain,application/msword,application/xml");
	...
	public static String getDownloadLocation() {
		String DownloadPath = "D:\\AUTOMATION REQUIRED DOCS\\CaseDetailsReport";
		return DownloadPath;
	}
...
public void validations() throws IOException{
	...
	public void clicklatere() throws Exception{

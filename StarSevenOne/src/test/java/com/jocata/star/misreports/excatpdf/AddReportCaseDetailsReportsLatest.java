...
public class AddReportCaseDetailsReportsLatest extends mainbaseLatest {
	...
	public void addReport() throws InterruptedException, IOException {
		...
		ExtentTestManager.startTest(" MIS Report :  Case Details Report ");
		...
		try {
			...
			String target = " Case Details Report";
			...
			fluentWait(By.xpath("//input[@id='reportName']")).sendKeys("Case details Report ");

			fluentWait(By.xpath(".//*[@id='reportDesc']")).sendKeys("Case Details Report");
			...
			sleep(8);
			ExtentTestManager.getTest().log(LogStatus.INFO, "CaseDetails Report Added SucessFully");

...
public class BenchMarkReportExtraction extends mainbaseLatest {
	...
	public void clicingmisreports() throws InterruptedException, HeadlessException, AWTException, IOException {
		...
		ExtentTestManager.startTest(" MIS Reports :  BenchMarkReport  ");
		...
		if(elementuser!=null){
		      WebDriverWait waitse = new WebDriverWait(driver, 80000);
		...
		ExtentTestManager.getTest().log(LogStatus.INFO, "BenchMarkReport downloaded sucessfully");

...
public class MisReportsDownload extends mainbaseLatest {
	...
	public void clickingmisreports() throws InterruptedException, IOException, HeadlessException, AWTException {
		...
		/*
		 * ExtentTestManager.getTest().log(LogStatus.INFO, "Screenshortbelow :"
		 * +ExtentTestManager.getTest().addScreenCapture(GetScreenshort.capture(
		 * driver, "ScreenshortForExtentReport")));
		 * 
		 * 
		 * fluentWait(By.xpath("(//img[@title='VIEW'])[3]")).click();
		 * 
		 * 
		 * Thread.sleep(40000); ExtentTestManager.getTest().log(LogStatus.INFO,
		 * "Screenshortbelow :"
		...
		ExtentTestManager.getTest().log(LogStatus.INFO, "Not Download");
		...
		ExtentTestManager.getTest().log(LogStatus.INFO,"Reports downloaded successfully");

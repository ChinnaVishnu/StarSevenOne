...
public class AddReportEventDetailsReport extends mainbaseLatest {
	...
	public void addReport() throws InterruptedException, IOException {
		...
		ExtentTestManager.startTest("  MIS Report :   Event Details Report ");
		...
		try {
			...
			String target = " Event Details Report";
			...
			fluentWait(By.xpath("//input[@id='reportName']")).sendKeys("EventDetailsReport");
			...
			sleep(8);
			ExtentTestManager.getTest().log(LogStatus.INFO, " Event Details Report  Added SucessFully");

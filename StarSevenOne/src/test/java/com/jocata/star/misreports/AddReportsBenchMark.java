...
public class AddReportsBenchMark extends mainbaseLatest {
	...
	public void addReport() throws InterruptedException, IOException {
		...
		try {
			ExtentTestManager.startTest("  MIS Report  :    Benchmark Details Report ");
			...
			String target = " Benchmarks Report";
			...
			fluentWait(By.xpath("//input[@id='reportName']")).sendKeys("BenchMarkDetails");
			...
			sleep(8);
			ExtentTestManager.getTest().log(LogStatus.INFO, " Benchmark Details Report Added SucessFully");

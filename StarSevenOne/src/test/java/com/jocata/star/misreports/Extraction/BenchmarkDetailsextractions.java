...
public class BenchmarkDetailsextractions  extends mainbaseLatest {
	...
	public void clicingmisreports() throws InterruptedException, HeadlessException, AWTException, IOException {
		...
		ExtentTestManager.startTest(" MIS Reports :  BenchmarkDetails  ");
		...
		ExtentTestManager.getTest().log(LogStatus.INFO, "BenchmarkDetails downloaded sucessfully");

...
import com.jocata.star.Mis.pdfreports.UserDe2;
import com.jocata.star.basescripts.ExtentTestManager;
import com.jocata.star.basescripts.GetScreenshort;
import com.jocata.star.basescripts.mainbaseLatest;
import com.relevantcodes.extentreports.LogStatus;

public class CaseDetailsReport extends mainbaseLatest {
	...
	public void clicingmisreports() throws InterruptedException, HeadlessException, AWTException, IOException {
		...
		ExtentTestManager.startTest(" MIS Reports :  CaseDetails ReportExport  ");
	...
	//	Runtime.getRuntime().exec("D:\\AUTOMATION REQUIRED DOCS\\WebDriverThrid");
		...
		ExtentTestManager.getTest().log(LogStatus.INFO, "CaseDetailsReport downloaded sucessfully");

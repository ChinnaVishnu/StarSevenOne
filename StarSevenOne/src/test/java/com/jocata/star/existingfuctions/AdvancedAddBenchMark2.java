...
public class AdvancedAddBenchMark2 extends mainbaseLatest {
	...
	public void clickAddbench() throws HeadlessException, AWTException, IOException {
		...
		ExtentTestManager.getTest().log(LogStatus.INFO,"benchmark added by "+createdt);
		

     String today=	CureentdateTime2 .getCurrentDate();
		System.out.println(today);
		
		if (createdt.equals(today)) {
			System.out.println("pass");
			ExtentTestManager.getTest().log(LogStatus.PASS,  " Benchmark Added Successfully ");
			ExtentTestManager.getTest().log(LogStatus.INFO, "Screenshortbelow :" + ExtentTestManager.getTest()
			.addScreenCapture(GetScreenshort.capture(driver, "ScreenshortForExtentReport")));
			...
			ExtentTestManager.getTest().log(LogStatus.FAIL,  " Benchmark not  added  ");
			ExtentTestManager.getTest().log(LogStatus.INFO, "Screenshortbelow :" + ExtentTestManager.getTest()
			.addScreenCapture(GetScreenshort.capture(driver, "ScreenshortForExtentReport")));
		}
		
		
		Assert.assertEquals(createdt, today);
